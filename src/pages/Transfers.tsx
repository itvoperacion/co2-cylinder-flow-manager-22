...
const Transfers = () => {
  ...
  const HARDCODED_CLIENTS: Client[] = [
    "ABEINSISTEMAS MCY","ABEINSISTEMAS LV","CEBRA S.A","CENTRO M. SAN JOSE","CENTRO ESP. MED. TURMERO",
    "CENTRO Q DEL SUR","FIREPROOF","EXTINTORES AMERICA","EXTINTORES AVILA","HOSP C. ARAGUA",
    "MC DONALDS ARC","MC DONALDS LA VICTORIA","MC DONALDS LAS AMERICAS","MC DONALDS LOS AVIADORES",
    "MC DONALDS SIGO MCY","MC DONALDS DELICIAS","PYROSHOW JOSE GONZALEZ","PYROSHOW GUSTAVO GIACOMO","SERVENTEX",
    "NITROX VALENCIA","MC DONALDS AV. CUARICENTENARIO","MC DONALDS EL VIÑEDO","MC DONALDS SAMBIL VLN",
    "MC DONALDS SAN DIEGO","MC DONALDS METROPOLIS","HIDTEC","BIGOT","MC DONALDS PTO CABELLO",
    "FEMSA ANTIMANO","FEMSA LOS CORTIJOS","FUND. BOL. Y MARTI","ABEIN SISTEMAS CARACAS","HOME CARE",
    "CLINICA AMAY","INST. CLINICO LA FLORIDA","CENTRO MEDICO SIEMPRE 2000","GREGOMAR ANTIMANO",
    "MC DONALDS SAN ANTONIO","ARTUROS CC LA CASCADA","MC DONALDS EL RECREO","MC DONALDS LA CASCADA",
    "MC DONALDS VIZCAYA","MC DONALDS SANTA FE","MC DONALDS SAN BERNARDINO","MC DONALDS CHARALLAVE",
    "MC DONALDS CATIA LA MAR","MC DONALDS PARAISO 1","MC DONALDS PARAISO 2","MC DONALDS CARABALLEDA",
    "MC DONALDS SAB. GRANDE","MC DONALDS CCT","MC DONALDS MILENIUN MALL","MC DONALDS CHACAITO",
    "MC DONALDS SAMBIL CANDL.","MC DONALDS SAMBIL CHACAO","MC DONALDS PARQUE CCS","MC DONALDS LA TRINIDAD",
    "MC DONALDS LA BOYERA","MC DONALDS LA CALIFORNIA","MC DONALDS LIDER MALL","MC DONALDS LAS MERCEDES",
    "MC DONALDS EL TOLON","MC DONALDS P LOS ILUSTRES","MC DONALDS LA CANDELARIA","MC DONALDS LA CASTELLANA",
    "MC DONALDS LA URBINA","MC DONALDS AV BARALT","MC DONALDS LOS TEQUES","MC DONALDS BUENAVENTURA",
    "MC DONALDS EL RECREO","MC DONALDS REGINA PLAZA","MC DONALDS INTERCOMUNAL","MC DONALDS PLAZA MAYOR",
    "MC DONALDS CUMANA","MC DONALDS MARGARITA","MC DONALDS ORINOKIA","MC DONALDS ALTA VISTA",
    "MC DONALDS CDAD BOLIVAR","MC DONALDS EL TIGRE","MC DONALDS MATURIN","MC DONALDS MARGARITA LOS ROBLES",
    "FEMSA BARCELONA","MC DONALDS GALERIAS MCBO","MC DONALDS DELICIAS NORTE","MC DONALDS SAN FRANCISCO",
    "MC DONALDS SAMBIL MCBO","MC DONALDS LAGO MALL","MC DONALDS CDAD OJEDA","MC DONALDS METROPOLIS BQTO",
    "MC DONALDS BQTO AV CENTRO","MC DONALDS BQTO AV LARA","MC DONALDS SAMBIL BQTO","MC DONALDS MAKRO BQTO",
    "MC DONALDS MERIDA","MC DONALDS MERIDA 57","MC DONALDS SAMBIL S. CRISTOBAL","MC DONALDS SAN CRISTOBAL",
    "MC DONLADS ROTARIA S. CRISTOBAL","MC DONALDS BARINAS","MC DONALDS BARINAS 2","MC DONALDS ARAURE",
    "MC DONALDS SAN FELIPE","MC DONALDS TRUJILLO","FEMSA SAN CRISTOBAL","INV A QUE LUIS","EXTINTORES PROINCA"
  ].map((name, i) => ({ id: String(i), name, zone: null }));
  ...
  const filteredTransfers = transfers.filter(transfer => {
    ...
    const matchesOrder = !orderFilter || (transfer.delivery_order_number && transfer.delivery_order_number.toLowerCase().includes(orderFilter.toLowerCase()));
    return matchesSearch && matchesLocation && matchesCapacity && matchesNotaEnvio && matchesOrder;
  });
  const {
    needsCustomerInfo,
    needsDriverInfo,
